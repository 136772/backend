...
from firstapp.views import index, detail, comment, index_login, index_register, vote, myinfo, myinfoupdate, mycollection
...
urlpatterns = [
    ...
    url(r'^myinfoupdate/$', myinfoupdate, name="myinfoupdate"),
